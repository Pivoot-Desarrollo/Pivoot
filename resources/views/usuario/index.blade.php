                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST" action="{{ url('usuario') }}"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="recipient-name"
                                                                class="col-form-label">Contraseña
                                                                usuario
                                                                <span class="text-danger">*</span>
                                                            </label>
                                                            <input value="{{ old('contraseña') }}" name="contraseña"
                                                                type="password" placeholder="Ingrese contraseña" readonly="readonly"
                                                                class="form-control input-md">
                                                            <strong
                                                                class="alert-danger">{{ $errors->first('contraseña') }}</strong>
                                                        </div>
