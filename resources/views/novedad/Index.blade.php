                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <ul>
                                                                            <li><strong>Identrenamiento: </strong>{{ $Novedad->idEntrenamientoFK }}</li><br>
                                                                            <li><strong>idUsuario: </strong>{{ $Novedad->idUsuarioFK }}</li><br>
                                                                            ...
                                                                            <li><strong>estado: </strong>{{ $Novedad->estado }}</li><br>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <center>
                                                                            <form method="POST"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="recipient-name"
                                                                                        class="col-form-label">idEntrenamientoFK
                                                                                        <span
                                                                                            class="text-danger">*</span>
                                                                                    </label>
                                                                                    <input
                                                                                        value="{{ $Novedad->idEntrenamientoFK }}"
                                                                                        name="idEntrenamientoFK"
                                                                                        placeholder="Ingrese IDEN"
                                                                                        class="form-control input-md">
                                                                                    <!--<strong
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    @foreach ($jugador as $Jugadores)
                                                                                        <option value="{{ $Jugadores->idJugador }}">
                                                                                            {{ $Jugadores->nombreJugador }}
                                                                                            {{ $Jugadores->apellidoJugador }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </select>
                                                                                    <!--<strong
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="{{ url('Novedad') }}"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="textinput">idEntrenamiento :</label>
                                                        <div class="col-md-4">
                                                            <input name="idEntrenamientoFK" type="text" placeholder="Ingrese la idEntrenamiento" required
                                                                class="form-control input-md">
                                                        </div>
                                                    </div>
